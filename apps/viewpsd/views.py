...
def calculate(request):
    ...
    ki=np.sqrt(Ei/2.072)
    kf=ki
    #a4=psdcali(al2o3file,calipath = 'psdcali/',a4c = None, vfile = None,veff = zeros(48),Ef = 0,pl = None, califile = None,psdrange = range(48),labels = '$Al_2O_3$', BGeff = True)
    al2o3file=os.path.join(os.path.dirname(os.path.realpath(__file__)),r"PSDCalibration_Jan2013.dat")
    #a4_differences=psd_william.psdcalia4(al2o3file,a4c = None, Ef = 0, psdrange=None)
    ...
    #print len(a4out)
    #print len(a3out)
    q,qx,qy=psd_william.convertq(ki,kf,a3out,a4out,phioff=0.0)
